...
contract("AssemblySol", function (/* accounts */) {
  it("it should get data", async function () {
    ...
    inputData = toByteArray(publicInputs.publicAmount)
    ...
    console.log("len(data):: ", out.length)
  ...
  it("should validate transaction", async function () {
    ...
    let input = ["0x0d071c363ce7dca404f6aceb4b734d081de0a92410899ebd88a15653187306b2"]

    const out = await instance.verifyInputs.call(
        a,b,c,input
    )
    data = out
    console.log("cdata:: ", data)
